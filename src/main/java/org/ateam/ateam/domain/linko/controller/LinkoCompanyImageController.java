...
public class LinkoCompanyImageController {
  ...
  public ResponseDto<LinkoCompanyImageResponse> uploadCompanyImage(
      @RequestPart("linkoId") Long linkoId, @RequestPart("file") MultipartFile file) {

    LinkoCompanyImageResponse response = linkoCompanyImageService.uploadCompanyImage(linkoId, file);
