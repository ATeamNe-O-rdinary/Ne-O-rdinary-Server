...
public class MemberController {
  ...
  public ResponseDto<CategoryOfBusiness> getCategoryOfBusiness(@RequestParam LinkTingRole linkTingRole){
  ...
  @GetMapping("/api/members/top")
    public ResponseDto<PagedResponse<?>> getMemberTopList(@RequestParam List<CategoryOfBusiness> categoryOfBusinessList,
                                                          @RequestParam LinkTingRole linkTingRole, Pageable pageable){
      PagedResponse<?> result = memberService.getTopProfiles(categoryOfBusinessList, linkTingRole, pageable);
    ...
    public ResponseDto<PagedResponse<?>> getMemberLatestList(@RequestParam List<CategoryOfBusiness> categoryOfBusinessList,
                                                          @RequestParam LinkTingRole linkTingRole, Pageable pageable){
        PagedResponse<?> result = memberService.getTopProfiles(categoryOfBusinessList, linkTingRole, pageable);
