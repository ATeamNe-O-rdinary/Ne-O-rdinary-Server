...
public class Linko extends BaseEntity {
    ...
    @Builder
    public Linko(Long memberId, String companyName, CompanyType companyType,
                 MainCategory mainCategory, CategoryOfBusiness categoryOfBusiness,
                 String projectIntro, String expectedDuration, String expectedScope,
                 CollaborationType collaborationType, Region region,
                 String deadline, String requiredSkills) {
